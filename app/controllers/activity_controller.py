...
def insert_user_activity(user_mdb_id: str, acticity_bucket: ActivityInfo):
    ...
    user_activity = ActivityUserDB(user_id=user_mdb_id, 
                                   activity_buckets=[acticity_bucket,])
    
    collection.insert_one(user_activity.dict())
    
def upload_activity(user_mdb_id: str, activity_data: ActivityInfo):
